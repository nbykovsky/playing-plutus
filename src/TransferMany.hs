...
import           Playground.Types           (KnownCurrency (..), PayToWalletParams (payTo))
...
pay = endpoint @"pay" @PaymentParams $ \params -> do
    let tx = mustPayToPubKey (beneficiary1 params) (Ada.lovelaceValueOf $ amount params) <> mustPayToPubKey (beneficiary2 params) (Ada.lovelaceValueOf $ amount params)
...
myTrace = do
    ...
    let params = PaymentParams { 
        beneficiary1 =  walletPubKeyHash w2, 
        beneficiary2 =  walletPubKeyHash w3, 
        amount      =  10000000
    }
